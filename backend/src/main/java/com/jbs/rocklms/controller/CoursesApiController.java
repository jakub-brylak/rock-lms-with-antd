package com.jbs.rocklms.controller;
...
@Component
public class CoursesApiController implements CoursesApiDelegate {
    
    private final CourseService courseService;
    private final CourseMapper courseMapper;
    
    @Autowired
    public CoursesApiController(CourseService courseService, CourseMapper courseMapper) {
